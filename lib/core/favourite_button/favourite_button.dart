...
class FavouriteButton extends StatefulWidget{
  ...
  const FavouriteButton(
      {super.key, required this.isFavourite,required this.courseId, this.index, this.height = 30, this.width = 30} );
...
class _FavouriteButtonScreenState extends State<FavouriteButton>{
  ...
  Widget build(BuildContext context) {
    return BlocConsumer<FavouriteCubit,FavouriteState>(listener: (context,state){},
        ...
        builder: (context,state){
          ...
          return InkWell(onTap: ()async{
            ...
            child: BlocBuilder<FavouriteCubit,FavouriteState>(builder:
                (context,state){
