...
import 'package:dr_nada_salma_med_edu_plat/features/profiles/presentation/widgets/log_out_widget.dart';
...
class MyProfilesScreen extends StatelessWidget {
  ...
  MyProfilesScreen({required this.profileCubit});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: customAppBar(
          appBarInd: 0,
          widget: SizedBox(),title: tr("my_profile"),status: false,context: context),
                ...
                child: Column(
                  ...
                  children: [
                    Container(
                      ...
                      , child: Text(tr("profile_settings"),style: TextStyles.textStyleBold12.copyWith(color: orangeBold,
                        fontWeight: FontWeight.w800),textScaler: TextScaler.linear(1),),
                    ),
                    SizedBox(height: context.height/40,),
                    InkWell(
                      onTap: (){
                        context.pushNamed(name: editProfileSc,args: profileCubit);
                      },
                      child: Row(
                        mainAxisAlignment: MainAxisAlignment.start,
                        ...
                        children: [
                          ...
                          Container(
                              ...
                              child: customSvg(name: editProfile
                                  ,width: context.width/20,height: context.width/20)),
                          SizedBox(width: context.width/50,),
                          Text(tr("edit_profile_data"),style: TextStyles.textStyleBold12
                    ...
                    InkWell(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Container(
                              alignment: Alignment.center,
                              child: customSvg(name: language,width: context.width/20,height: context.width/20)),
                          SizedBox(width: context.width/30,),
                          Text(tr("language"),style: TextStyles.textStyleBold12
                              .copyWith(color: primary),textScaler: TextScaler.linear(1),),
                          Spacer(),
                          context.locale.languageCode == "ar" ?
                          Transform.rotate(
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    Container(
                      margin : EdgeInsets.only(left: context.width/15,right: context.width/15)
                      , child: Text(tr("account_settings"),style: TextStyles.textStyleBold12.copyWith(color: orangeBold,
                        fontWeight: FontWeight.w800),textScaler: TextScaler.linear(1),),),
                    ...
                    InkWell(
                      onTap: (){
                        ...
                        BlocProvider.value(value: profileCubit,
                            child: AlertDialog(
                              ...
                              title:  Column(
                                children: [
                                  Text(tr("delete_your_account"),
                                    style: TextStyles.textStyleBold16.copyWith(color: red)
                              ...
                              content:  Text(tr("reversible"), style: TextStyles.textStyleNormal10
                                ...
                                BlocBuilder<ProfileCubit, ProfileState>(
                                  builder: (context, state) {
                                    return
                                      ...
                                      context.read<ProfileCubit>().deleteLoading == true ?
                                      SizedBox(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Container(
                              alignment: Alignment.center,
                              child: customSvg(name: clear,width: context.width/20,height: context.width/20)),
                          SizedBox(width: context.width/30,),
                          Text(tr("delete_account"),style: TextStyles.textStyleBold12
                              .copyWith(color: primary),textScaler: TextScaler.linear(1),),
                          Spacer(),
                                  context.locale.languageCode == "ar" ?
                                  Transform.rotate(
                    ...
                    InkWell(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Container(
                              alignment: Alignment.center,
                              child: customSvg(name: logout,width: context.width/20,height: context.width/20)),
                          SizedBox(width: context.width/30,),
                          Text(tr("logout"),style: TextStyles.textStyleBold12
                              .copyWith(color: primary),textScaler: TextScaler.linear(1),),
                          Spacer(),
                          context.locale.languageCode == "ar" ?
                          Transform.rotate(
