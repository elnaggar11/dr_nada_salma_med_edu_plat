...
class EditProfileScreen extends StatefulWidget {
  ...
  EditProfileScreen({required this.profileCubit});
...
class _EditProfileScreenState extends State<EditProfileScreen> {
  ...
  @override
  void initState() {
   fullNameController.text = widget.profileCubit.profileResponse!.data!.fullName!;
   phoneNumberController.text = "${widget.profileCubit.profileResponse!.data!.phoneNumber??""}";
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: customAppBar(
          appBarInd: 0,
          widget: SizedBox(),title: tr("edit_profile_data"),status: false,context: context),
          ...
          child: Column(
            ...
            children: [
                    ...
                    children: [
                      context.read<ProfileCubit>().img == null ?
                       Container(
                            ...
                            child: ClipOval(
                              child: NetWorkImageHandler(image: widget.profileCubit.profileResponse!.data!.image!
                     ...
                     Container(
                          ...
                          child: ClipOval(
                            child: Image.file(context.read<ProfileCubit>().img!,
                              width: context.width/4.4,height: context.width/4.4
                              ,fit: BoxFit.cover,alignment: Alignment.center,),
                          ),),

                      SizedBox(height: context.height/60,),
                      Text(tr("upload"),style: TextStyles.textStyleNormal10
                          .copyWith(color: orangeBold,)
                        ,textScaler: TextScaler.linear(1),textAlign: TextAlign.center,),
                      SizedBox(height: context.height/60,),
                      Text("Maximum size: 1MB. Supported formats: JPG, GIF, or PNG."
                        ,style: TextStyles.textStyleNormal10.copyWith
                          (fontWeight: FontWeight.w500,color: primary),textScaler: TextScaler.linear(1),),
                      SizedBox(height: context.height/30,),
                      Container(
                          alignment: Alignment.center,
                          child: customSvg(name: upload2,width: context.width/6
              ...
              CustomTextField(
                ...
                labelTxt: tr("full_name"),hintText: tr("full_name"),),
              SizedBox(height: context.height/30,),
            /*  Container(
