...
class LanguageItem extends StatelessWidget {
  ...
  const LanguageItem({super.key, required this.item, required this.index});
            ...
            child: CheckboxListTile(
              ...
              title: Text(
                ...
                style: TextStyles.textStyleBold12.copyWith(
                  color: item['isChecked'] == true ? white : primary,
                  fontFamily: poppins,
              ...
              onChanged: (value) {
                context.read<LanguageCubit>().setSelectedCheckBox(
                  ind: index,
                  val: value,
                );
              },
