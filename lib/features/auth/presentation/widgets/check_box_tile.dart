...
class CheckboxListTileWidget extends StatefulWidget {
  ...
  const CheckboxListTileWidget({required this.title});
  ...
  Widget build(BuildContext context) {
    return  Center(
        child: CheckboxListTile(
          ...
          ListTileControlAffinity.trailing : ListTileControlAffinity.leading,
          ...
          title:  Transform.translate(
            ...
            child:  RichText(
                  ...
                  text: TextSpan(
                    children: [
                      TextSpan(text: tr("by_click")
                        ,style: TextStyles.textStyleNormal13
                            .copyWith(fontFamily: lamaSans,color: grey1),),

                      TextSpan(text: " ${widget.title}"
                        ,style: TextStyles.textStyleNormal13
                            .copyWith(fontFamily: lamaSans,color: primary),),
                      TextSpan(text: tr("you_agree")
                        ,style: TextStyles.textStyleNormal13
                            .copyWith(fontFamily: lamaSans,color: grey1),),
                      TextSpan(text: tr("terms_conditions_privacy")
                        ,style: TextStyles.textStyleNormal13
                            .copyWith(fontFamily: lamaSans,color: orangeBold),),
                    ]
                  )),
          ...
          contentPadding: EdgeInsets.only(left: context.width/60,right: context.width/60)
        ),
      );
