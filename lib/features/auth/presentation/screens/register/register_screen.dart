...
class _RegisterScreenState extends State<RegisterScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: customAppBar(
        appBarInd: -1,
          widget: SizedBox(), title: tr("register"), status: false, context: context,index: -1),
      body: SizedBox(
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(tr("create_new_account"),style: TextStyles.textStyleExtraBold24
                ...
                CustomTextField(controller: fullNameController, obscure: false
                  ,suffixIcon: Container(
                    width: context.width/15,
                      margin: EdgeInsets.only(left: context.width/20,right: context.width/20),
                      alignment: Alignment.center,
                      child: customSvg(name: user,width: context.width/20
                          ,height: context.width/20)) ,prefixIcon: SizedBox(width: 0,),
                  labelTxt: tr("full_name"),hintText: tr("enter_full_name"),
                ...
                Container(
                  ...
                  child: IntlPhoneField(
                    ...
                    dropdownTextStyle: TextStyles.textStyleNormal14.copyWith(color: black),
                    validator: (val){
                    ...
                    decoration: InputDecoration(
                      contentPadding: EdgeInsets.only(top: context.width/20,bottom: context.width/20),
                ...
                BlocBuilder<RegisterCubit, RegisterState>(
                  builder: (context, state) {
                    return CustomTextField(controller: passwordController,
                  ...
                  ,suffixIcon: InkWell(
                        ...
                        onTap: (){
                          context.read<RegisterCubit>().setVisibility(visibility:
                          context.read<RegisterCubit>().obscure,type: "password");
                        },
                    child: Container(
                        width: context.width/15,
                        margin: EdgeInsets.only(left: context.width/20,right: context.width/20),
                ...
                BlocBuilder<RegisterCubit, RegisterState>(
                  ...
                  ,suffixIcon: InkWell(
                        ...
                        onTap: (){
                          context.read<RegisterCubit>().setVisibility(visibility:
                          context.read<RegisterCubit>().obscure2,type: "confirmPassword");
                        },
                    child: Container(
                        ...
                        customSvg(name: visible,width: context.width/20
                            ,height: context.width/20)
                        ),
                  ) ,prefixIcon: SizedBox(width: 0,),
                  labelTxt: tr("confirm_pass"),hintText: tr("enter_confirm_password"),);},),
                      ...
                      onButtonPressed: (){
                        if(context.read<RegisterCubit>().isChecked == false){
                          ...
                          if(formKey.currentState!.validate()){
                            ...
                            RegisterParams(fullName: fullNameController.text
                ...
                RichText(
                    ...
                    text: TextSpan(
                  children: [
                    TextSpan(text: tr("have_account"),style: TextStyles
                        .textStyleNormal14.copyWith(color: black)),
                    TextSpan(text: tr("log_in"),style: TextStyles
