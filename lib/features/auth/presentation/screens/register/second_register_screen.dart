...
class SecondRegisterScreen extends StatefulWidget {
  ...
  const SecondRegisterScreen({super.key, required this.email});
                            ...
                            onButtonPressed: () {
                              if (context
                                ...
                                context
                                    .read<AcademicInfoCubit>()
                                    .setAcademicInfo(
                                      params: AcademicInfoParams(
                                        email: widget.email,
                                        specialists: context
                                            .read<SpecialistsCubit>()
                                            .specialistId,
                                        academicDegrees: context
                                            .read<AcademicDegreeCubit>()
                                            .academicDegreeId,
                                      ),
                                    );
