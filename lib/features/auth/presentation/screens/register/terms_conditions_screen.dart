...
class TermsConditionsScreen extends StatelessWidget {
  ...
  const TermsConditionsScreen({super.key, required this.params});
      ...
      body: Column(
        ...
        children: [
          ...
          Container(
            ...
            child: Text(
              tr("information_confidentiality"),
              style: TextStyles.textStyleBold18.copyWith(color: orangeBold),
              textScaler: TextScaler.linear(1),
            ),
          ),
                ...
                onButtonPressed: () {
                  if (context.read<RegisterCubit>().isChecked == false) {
                    ...
                    Future.delayed(
                      ...
                      () => navKey.currentContext!.pushNamed(
                        name: verificationSc,
                        args: params1,
                      ),
                    );
