         ...
         child: SingleChildScrollView(
           child: Column(
             ...
             children: [
               ...
               Text(tr("reset_pass"),style: TextStyles.textStyleBold28.copyWith(color: orangeBold),),
               ...
               BlocBuilder<ResetPassCubit, ResetPassState>(
                 ...
                 labelTxt: tr("set_new_pass"),labelColor: orangeBold,
                 suffixIcon: InkWell(
                     ...
                     onTap: (){
                       context.read<ResetPassCubit>()
                           .setVisibility(visibility: context
                           .read<ResetPassCubit>().obscure!,type: "password");
                     },
               ...
               BlocBuilder<ResetPassCubit, ResetPassState>(
                 builder: (context, state) {
                   return CustomTextField(controller: confirmPassController,
                     obscure: context.read<ResetPassCubit>().obscure2!,
                 labelTxt: tr("confirm_new_pass"),labelColor: orangeBold,
                 suffixIcon: InkWell(
                     splashColor: Colors.transparent,
                     highlightColor: Colors.transparent,
                     hoverColor: Colors.transparent,
                   onTap: (){
                     context.read<ResetPassCubit>()
                         .setVisibility(visibility: context
                         .read<ResetPassCubit>().obscure2!,type: "confirmPassword");
                   },
                   ...
                   Container(
                     width: context.width/20,
                     alignment: Alignment.center,
                     child: customSvg(name: visible,width: context.width/30
                 ...
                 ,isPressed: false
                     ...
                     if(formKey.currentState!.validate()){
                       print("confirmPass: ${confirmPassController.text}"
                           ...
                           "email : ${widget.params.email}  otp :" +widget.params.otp.toString());
                    context.read<ResetPassCubit>()
