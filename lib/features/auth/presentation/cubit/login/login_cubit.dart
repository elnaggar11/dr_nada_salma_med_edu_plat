  ...
  Future<void>login({LoginParams? params})async{
    ...
    try{
      ...
      failOrUser.fold((fail){
        ...
        msgKey.currentState!.showSnackBar(SnackBar(
            behavior: SnackBarBehavior.floating,
            content: Text(user.message!,style: TextStyles
            .textStyleNormal13.copyWith(color: white),textScaler: TextScaler.linear(1),)));
      ...
      msgKey.currentState!.showSnackBar(SnackBar(
          behavior: SnackBarBehavior.floating,
          shape: OutlineInputBorder(borderRadius: BorderRadius.all(Radius.circular(30))),
          content: Text(e.toString(),style: TextStyles
          .textStyleNormal13.copyWith(color: white),textScaler: TextScaler.linear(1),)));
    }
  }
