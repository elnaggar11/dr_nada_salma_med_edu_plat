...
class BlogDetailsScreen extends StatefulWidget {
  ...
  const BlogDetailsScreen({super.key, required this.blogDetailsParams});
...
class _BlogDetailsScreenState extends State<BlogDetailsScreen> {
  ...
  void initState() {
    context.read<BlogDetailsCubit>().getBlogDetails(
      params: BlogDetailsParams(slug: widget.blogDetailsParams.slug),
    );
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: customAppBar(
        ...
        status: false,
        context: context,
        title: widget.blogDetailsParams.title,
        appBarInd: 0,
      ),
                  ...
                  BlocBuilder<BlogDetailsCubit, BlogDetailsState>(
                    builder: (context, state) {
                      return context.read<BlogDetailsCubit>().loading == true
                          ...
                          : Text(
                              "${context.read<BlogDetailsCubit>().blogBySlugResponse!.data!.categoryName}",
                  ...
                  return context.read<BlogDetailsCubit>().socialLoading == true
                      ...
                      : Row(
                          ...
                          children: [
                            InkWell(
                              onTap: () {
                                context.read<BlogDetailsCubit>().fetchUrl(
                                  url: context
                                      .read<BlogDetailsCubit>()
                                      .socialMediaResponse!
                                      .data![6]
              ...
              builder: (context, state) {
                return context.read<BlogDetailsCubit>().loading == true
                    ...
                    : DescriptionHeadTitle(
                        title:
                            "1. ${context.read<BlogDetailsCubit>().blogBySlugResponse!.data!.metaTitle}",
                      );
              },
            ),
            SizedBox(height: context.height / 60),
              ...
              builder: (context, state) {
                return context.read<BlogDetailsCubit>().loading == true
                    ...
                    : DescriptionContentItem(
                        content:
                            "${context.read<BlogDetailsCubit>().blogBySlugResponse!.data!.metaDescription}",
                      );
              },
            ),
            SizedBox(height: context.height / 18),
