...
class CategoriesWithBlogUseCase extends UseCase<CategoriesWithBlogResponse,NoParams>{
  final BlogsRepositories blogsRepositories;

  CategoriesWithBlogUseCase(this.blogsRepositories);

  @override
  Future<Either<Failure, CategoriesWithBlogResponse>> call(NoParams params)async {
