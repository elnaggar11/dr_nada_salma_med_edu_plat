...
class ComingSoonItem extends StatelessWidget {
  ...
  const ComingSoonItem({required this.title,required this.img,required this.progress
    ,required this.points, required this.slug, required this.totalHours,
    required this.categoryName, required this.lectureNum, required this.sectionNum});

  @override
  Widget build(BuildContext context) {
    return InkWell(
      onTap: (){
        CoursesDetailsParams params = CoursesDetailsParams(slug: slug,status: "");
              ...
              Container(
                  ...
                  child: Row(
                    children: [
                      ...
                      Text(tr("very_soon"),style: TextStyles.textStyleNormal10
