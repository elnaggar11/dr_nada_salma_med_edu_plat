...
class CoursesRemoteDataSourceImpl implements CoursesRemoteDataSource {
  ...
  @override
  Future<CoursesStatusResponse> getCoursesStatus({CoursesStatusParams? params}) async{
    try{
      final response = await helper.get(url: coursesTypesApi+params!.coursesType!+params.courseStatus!);
