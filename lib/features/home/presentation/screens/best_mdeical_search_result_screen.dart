...
class BestMedicalSearchResultScreen extends StatefulWidget {
  ...
  const BestMedicalSearchResultScreen({super.key, required this.coursesParams});

  @override
  State<BestMedicalSearchResultScreen> createState() =>
      _BestMedicalSearchResultScreenState();
}

class _BestMedicalSearchResultScreenState
    extends State<BestMedicalSearchResultScreen> {
  final TextEditingController searchController = TextEditingController();
  @override
  void initState() {
    context.read<PublicCoursesCubit>().getPublicCourses(
      categoryId: widget.coursesParams.categoryId.toString(),
                ...
                child: MediaQuery(
                  ...
                  child: TextField(
                    ...
                    onChanged: (val) {
                      ...
                      context.read<PublicCoursesCubit>().getPublicCourses(
                        topRated: widget.coursesParams.topRated.toString(),
                        type: 'filter',
                        name: searchController.text,
                        categoryId: widget.coursesParams.categoryId,
                      );
                    },
                ...
                return context.read<PublicCoursesCubit>().loading == true
                    ...
                    : ListView.builder(
                        ...
                        padding: EdgeInsets.only(
                          ...
                          right: context.width / 45,
                        ),
                        shrinkWrap: true,
                        physics: ClampingScrollPhysics(),
                        itemBuilder: (context, index) =>
                            BestMedicalVerticalItem(
                              typeIndex: 1,
                              data: context
                                  .read<PublicCoursesCubit>()
                                  .publicCoursesResponse!
