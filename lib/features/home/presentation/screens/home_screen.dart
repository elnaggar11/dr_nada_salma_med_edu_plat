...
class _HomeScreenState extends State<HomeScreen> {
  ...
  void initState() {
    ...
    context.read<PublicCoursesCubit>().resetCourses(params: CoursesParams(type: '', categoryId: '',
        topRated: '',courseName: ""));
    context.read<PrivateLessonsCubit>().getPrivateLessons(params: CoursesParams(type: ''));
                ...
                children: [
                  ...
                  ClipOval(
                    child: NetWorkImageHandler
                      (image: context.read<ProfileCubit>().profileResponse!.data!.image!
                  ...
                  Column(
                    ...
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text("${context.read<ProfileCubit>().profileResponse!.data!.fullName}"
                        ,style: TextStyles.textStyleBold14.copyWith(color: orangeBold
                          ,fontWeight: FontWeight.w800),textScaler: TextScaler.linear(1),),
                      SizedBox(height: context.height/280,),
                      Text("${context.read<ProfileCubit>().profileResponse!.data!
                          .specialties![0].name}",style: TextStyles.textStyleNormal12
                        ...
                        children: [
                          ...
                          Positioned(
                            ...
                            child: BlocBuilder<NotificationsCubit, NotificationsState>(
                              builder: (context, state) {
                                return Container(
                                  padding: EdgeInsets.all(context.width/80),
                              decoration: BoxDecoration(
                                color: red,
                                shape: BoxShape.circle),
                              child: context.read<NotificationsCubit>().loading == true ?
                                  SpinKitPulse(color: white,size: 9,) :
                              Text("${context.read<NotificationsCubit>()
              ...
              Row(children: [
                ...
                Expanded(child:  MediaQuery(
                  ...
                  child: TextField(
                      ...
                      onChanged: (val){
                        context.read<PublicCoursesCubit>().resetCourses(params: CoursesParams(type: 'filter'
                            , categoryId: '1',
                            topRated: '1',courseName: searchController.text));
                      },
                      decoration: InputDecoration(
                        ...
                        suffixIcon: InkWell(
                          onTap: (){
                            ...
                            context.read<PublicCoursesCubit>().resetCourses(params: CoursesParams(type: ''
                                , categoryId: '',
                                topRated: '',courseName: ''));
                          },
                          child: Container(
                            ...
                            width: context.width/15,
                              alignment: Alignment.center,
                              child: Icon(Icons.clear,color: primary,size: 20,)),
                        ),
      ...
      Container(
                ...
                decoration: BoxDecoration(
                  image: DecorationImage(image: NetworkImage(
                      context.read<HeroesCubit>()
                          .heroResponse == null ? "" :
                      context.read<HeroesCubit>()
                      .heroResponse!.data!.image!),fit: BoxFit.cover,scale: 1.0
                      ,alignment: Alignment.center),
                    color: accent,
                  ...
                  children: [
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        SizedBox() :
                        Text(context.read<HeroesCubit>().heroResponse!.data!.title!??""
                          ,style: TextStyles.textStyleBold15
                            .copyWith(fontWeight: FontWeight.w800,color: white),textScaler: TextScaler.linear(1),),
                        SizedBox(height: context.height/100,),
                        context.read<HeroesCubit>().heroResponse == null ?
                        SizedBox() :
                        Text(context.read<HeroesCubit>().heroResponse!.data!.description!??""
                        ...
                        InkWell(
                          ...
                          child: Container(
                            margin: EdgeInsets.only(bottom: context.height/40,right: context.width/3.5),
                            padding: EdgeInsets.only(top: 11,bottom: 11,left: 11),
                            alignment: Alignment.center,
                            decoration: BoxDecoration(
                              color: primary,
              ...
              Container(
                ...
                child: Row(
                  ...
                  crossAxisAlignment: CrossAxisAlignment.center,
                  children: [
                    Text(tr("best_medical_courses"),style: TextStyles.textStyleBold20
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Transform.rotate(
                            ...
                            child:  Container(
                                alignment: Alignment.center,
                                child: customSvg(name: raw,width: context.width/25
              ...
              BlocBuilder<PublicCoursesCubit,PublicCoursesState>(
                builder: (context, state) {
                  ...
                  context.read<PublicCoursesCubit>().publicCoursesResponse == null ?
                     NoCourseWidget() :
                    BestMedicalList(publicCoursesResponse:
                    context.read<PublicCoursesCubit>().publicCoursesResponse!,);
                  },),
              SizedBox(height: context.height/28,),
              Container(
                margin: EdgeInsets.only(left: context.width/20,right: context.width/20),
                child: Row(
                  ...
                  crossAxisAlignment: CrossAxisAlignment.center,
                  children: [
                    Text(tr("top_private_lessons"),style: TextStyles.textStyleBold20
                        .copyWith(color: primary,fontWeight: FontWeight.w800,overflow: TextOverflow.ellipsis)
                      ,textScaler: TextScaler.linear(1),maxLines: 1,),
                    Spacer(),
                    TextButton(
              ...
              SizedBox(height: context.height/40,),
                ...
                builder: (context, state) {
                  ...
                  BestMedicalShimmerList() :
                  context.read<PrivateLessonsCubit>()
                      .publicCoursesResponse == null ?
                      EmptyCourseWidget():
                  context.read<PrivateLessonsCubit>()
                      .publicCoursesResponse!.data!.isEmpty ?
                  NoCourseWidget():
                   PrivateLessonsList(lessonsList: context.read<PrivateLessonsCubit>()
                        .publicCoursesResponse!.data!);},
              ),
              SizedBox(height: context.height/30,),
              Container(
                margin: EdgeInsets.only(left: context.width/20,right: context.width/20),
                child: Row(
                  ...
                  crossAxisAlignment: CrossAxisAlignment.center,
                  children: [
                    Text(tr("success_stories"),style: TextStyles.textStyleBold20
                        .copyWith(color: primary,fontWeight: FontWeight.w800,overflow: TextOverflow.ellipsis)
                      ,textScaler: TextScaler.linear(1),maxLines: 1,),
                    Spacer(),
                    TextButton(
              ...
              BlocBuilder<SuccessStoriesCubit, SuccessStoriesState>(
                builder: (context, state) {
                  ...
                  SuccessStoriesShimmerList() :
                    SuccessStoriesList(successStoriesResponse: context.read<SuccessStoriesCubit>
