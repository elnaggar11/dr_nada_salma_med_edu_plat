...
class PrivateLessonsSearchResultScreen extends StatefulWidget {
  ...
  const PrivateLessonsSearchResultScreen({super.key, required this.params});

  @override
  State<PrivateLessonsSearchResultScreen> createState() =>
      _PrivateLessonsSearchResultScreenState();
}

class _PrivateLessonsSearchResultScreenState
    extends State<PrivateLessonsSearchResultScreen> {
  ...
  void initState() {
    context.read<PrivateLessonsCubit>().getPrivateLessons(
      params: CoursesParams(
        categoryId: widget.params.categoryId.toString(),
        courseName: searchController.text,
        topRated: widget.params.topRated,
      ),
    );
    super.initState();
  }
