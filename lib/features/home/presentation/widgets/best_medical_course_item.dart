...
class BestMedicalItem extends StatelessWidget {
  ...
  const BestMedicalItem({required this.data});
          ...
          children: [
            Stack(
              ...
              ClipRRect(
                ...
                child: NetWorkImageHandler(image: data.image!, width: context.width/1.6, height: context.height/4.3),),
                BlocProvider(
            ...
            Text(data.title.toString(),style: TextStyles.textStyleBold16.copyWith
              (fontWeight: FontWeight.w800,color: orangeBold),maxLines: 1
