...
class WatchCourseUseCase extends UseCase<WatchCourseResponse,WatchCourseParams>{
  final HomeRepositories homeRepositories;

  WatchCourseUseCase(this.homeRepositories);

  @override
  Future<Either<Failure, WatchCourseResponse>> call(WatchCourseParams params) async{
