...
class _FavouriteScreenState extends State<FavouriteScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        appBar: customAppBar(
          appBarInd: 0,
            title: tr("favorites"), context: context,
            status: false,
            widget: Row(
              ...
              children: [
                ...
                Text(tr("clear_all"), style: TextStyles.textStyleNormal12
        ...
        body: SizedBox(
          ...
          child: BlocBuilder<FavouriteCubit, FavouriteState>(
            builder: (context, state) {
              ...
              (context.read<FavouriteCubit>().favouriteResponse == null || context.read<FavouriteCubit>().favouriteResponse!.data!.isEmpty) ?
                  Container(
                    width: double.infinity,
                    height: double.infinity,
                    ...
                    child: Column(
                      ...
                      children: [
                        Container(
                          ...
                          child: customSvg(name: heart,color: primary,width: context.width/5
                              ,height: context.width/5),
                        ),
                        SizedBox(height: context.height/80,),
                        Text(tr("no_favourite")
                ...
                ListView.builder(
                  itemCount: context.read<FavouriteCubit>().favouriteResponse!.data!.length,
                  padding: EdgeInsets.only(top: 0),
                  physics: ClampingScrollPhysics(),
                  shrinkWrap: true,
                  itemBuilder: (context, index) =>
                      FavouriteItem(data: context.read<FavouriteCubit>().favouriteResponse!.data![index],));
            },
          ),
        )
    );
