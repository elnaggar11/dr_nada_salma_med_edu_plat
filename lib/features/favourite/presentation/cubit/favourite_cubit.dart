...
import 'package:dr_nada_salma_med_edu_plat/features/favourite/domain/entities/favourtie_response.dart' hide Data;
...
class FavouriteCubit extends Cubit<FavouriteState> {
  FavouriteCubit(this.favouriteUseCase, this.favByUserUseCase) : super(FavouriteInitial());
  ...
  toggleFavAd(String? adId) async {
    ...
    final failOrSuccess =
    await favouriteUseCase(FavouriteParams(favouriteId: adId));
